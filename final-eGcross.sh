...
../../sources/eglibc-2.16/libc/configure \
	...
	--config-cache \
	--enable-kernel=3.0.52 \
        --disable-profile --without-gd --without-cvs --enable-add-ons=$SRCDIR/eglibc-2.16/ports,nptl 
...
../../sources/eglibc-2.16/libc/configure \
	...
	--config-cache \
	--enable-kernel=3.0.52 \
     	--disable-profile --without-gd --without-cvs --enable-add-ons=$SRCDIR/eglibc-2.16/ports,nptl --with-tls
